...
export const ProductSale = () => {
    ...
    const productSale = products.filter((product) => product.saleProduct === true);
    ...
    return (
        <div className="bg-gray-100 py-10">
            <Filter productLength={productSale.length}/>
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl font-bold text-gray-800 mb-6">Danh sách sản phẩm đang giảm giá</h2>
